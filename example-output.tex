...
\begin{document}
\begin{letter}{{Sam Smith}\\{123 Imaginary Way}}

\opening{Hello,} % eg Hello.
This is an example of the ParamaTeX substitution program. It takes a variable and replaces it with the desired data. So rather than seeing a generic variable, {Sam Smith} sees their own name on the header. 
